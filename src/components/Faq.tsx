...
const faqData: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Нет. Все команды спрятаны за переключателями и ползунками.",
  },
  {
    q: "Какие платформы поддерживаются?",
    a: "Сейчас — только Windows. Приложение собрано на Tauri, поддержка других платформ не планируется.",
  },
  {
    q: "Останется ли программа бесплатной?",
    a: "Да, Rust Temper бесплатен и останется таким.",
  },
];
